...
export class PoeApi {
    ...
    constructor() {
        ...
        this.stashTabContent$.subscribe((stashUpdate) => {
            ...
            this.currentItems.next(Object.values(nextStash).flatMap(((stash: any) => stash.items)))
        })
    }
