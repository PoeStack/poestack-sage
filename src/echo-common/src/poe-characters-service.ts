...
export class PoeCharactersService {
  public characterListCache = new CachedTask<PoeCharacter[]>(this.echoDir, () => this.gggApi.getCharacters())
  public characterCache = new CachedTask<PoeCharacter>(this.echoDir, (key) => this.gggApi.getCharacter(key))
