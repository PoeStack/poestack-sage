...
export class PoeLogService {
    ...
    private getLogFilePath(): string | null {
        const possiblePaths = [
            path.join("C:", "Program Files (x86)", "Grinding Gear Games", "Path of Exile", "logs", "Client.txt"),
            path.join("C:", "Program Files", "Grinding Gear Games", "Path of Exile", "logs", "Client.txt"),
