...
test('PoeClientLogService ZoneEnteranceEventParser test', async () => {
  ...
  fs.appendFileSync(
    file,
    "2023/11/17 14:31:13 1915613 cffb0716 [INFO Client 200] : You have entered Lioneye's Watch.\n"
  )

  fs.appendFileSync(
    file,
    '2023/11/17 14:30:04 1847032 f22b6b6e [INFO Client 200] Tile hash: 3760384659\n'
  )

  fs.appendFileSync(
    file,
    "2023/11/17 14:31:13 1915615 cffb0716 [INFO Client 200] : You have entered Lsioneye's Watch.\n"
  )
...
test('PoeClientLogService GeneratingAreaEventParser test', async () => {
  ...
  let eventData: PoeGeneratingAreaEvent[] = []
  ...
  return new Promise((resolve) => setTimeout(resolve, 100)).then(() => {
    expect(eventData[0].areaLevel).toBe(70)
    expect(eventData[0].areaTag).toBe('MapWorldsEstuary')
    expect(eventData[0].seed).toBe(201940244)
...
test('PoeClientLogService InstanceConnectionEventParser test', async () => {
  ...
  fs.appendFileSync(
    file,
    '2023/11/17 14:32:31 1993666 ca3a6a7f [INFO Client 200] Connecting to instance server at 37.61.215.13:6112\n'
  )
  ...
  fs.appendFileSync(
    file,
    '2023/11/17 14:32:31 1993666 327588d4 [INFO Client 200] [SHADER] Delay: OFF\n'
  )
...
test('PoeClientLogService CharacterSlainEventParser test', async () => {
  ...
  fs.appendFileSync(
    file,
    '2023/11/17 14:31:37 1940444 cffb0716 [INFO Client 200] : tertsdfwersd has been slain.\n'
  )
  ...
  fs.appendFileSync(
    file,
    '2023/11/17 14:31:37 1940444 cffb0716 [INFO Client 200] : someꞨꞨstrange has been slain.\n'
  )

  fs.appendFileSync(
    file,
    '2023/11/17 14:31:37 1940444 cffb0716 [INFO Client 200] : some福福strange has been slain.\n'
  )

  fs.appendFileSync(
    file,
    '2023/11/17 14:31:37 1940444 cffb0716 [INFO Client 200] : someさくらstrange has been slain.\n'
  )

  fs.appendFileSync(
    file,
    '2023/11/17 14:31:37 1940444 cffb0716 [INFO Client 200] : someёшкаstrange has been slain.\n'
  )
...
test('PoeClientLogService NPCEncounterEventParser test', async () => {
  ...
  fs.appendFileSync(
    file,
    '2023/11/17 09:03:32 372493 cffb0716 [INFO Client 200] Einhar, Beastmaster: Exile! You are a welcome omen.\n'
  )
  fs.appendFileSync(
    file,
    '2023/11/21 22:39:42 96053513 cffb0716 [INFO Client 204] Alva, Master Explorer: Just in time.\n'
  )
  fs.appendFileSync(
    file,
    '2023/11/21 22:53:17 96868783 cffb0716 [INFO Client 204] Niko, Master of the Depths: Good good good good.\n'
  )
  fs.appendFileSync(
    file,
    '2023/11/22 10:27:30 98110186 cffb0716 [INFO Client 204] Jun, Veiled Master: Surely you want the thrill of a free for all, warrior!\n'
  )
  fs.appendFileSync(
    file,
    '2023/11/22 10:42:06 98986720 cffb0716 [INFO Client 204] Sister Cassia: Oh!\n'
  )
  fs.appendFileSync(
    file,
    '2023/11/17 09:01:26 247170 cffb0716 [INFO Client 200] Strange Voice: They are using you. Everyone is simply using you.\n'
  )
  fs.appendFileSync(
    file,
    '2023/11/22 10:44:06 99106518 cffb0716 [INFO Client 204] Oshabi: This way, Exile.\n'
  )
  fs.appendFileSync(
    file,
    "2023/11/22 15:26:46 106868352 cffb0716 [INFO Client 204] Tujen, the Haggler: Come on now, don't got all day!\n"
  )
  fs.appendFileSync(
    file,
    '2023/11/22 15:27:31 106912869 cffb0716 [INFO Client 204] Gwennen, the Gambler: Finally! Come on!\n'
  )
  fs.appendFileSync(
    file,
    "2023/11/22 15:33:18 107259420 cffb0716 [INFO Client 204] Rog: I've got another one for ya!\n"
  )
  fs.appendFileSync(
    file,
    "2023/11/22 15:33:18 107259420 cffb0716 [INFO Client 204] Dannig: I've got another one for ya!\n"
  )
  fs.appendFileSync(
    file,
    '2023/11/17 14:32:31 1993666 327588d4 [INFO Client 200] [SHADER] Delay: OFF\n'
  ...
  return new Promise((resolve) => setTimeout(resolve, 100)).then(() => {
    ...
    expect(eventData[5].subtype).toBe('DeliriumMirrorEvent')
