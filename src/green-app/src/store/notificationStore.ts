...
type State = {
  ...
  openTradeOverviewInNewWindow: boolean
}
...
type Actions = {
  ...
  setMaxActiveToasts: (maxActiveToasts: number) => void
  setOpenTradeOverviewInNewWindow: (newWindow: boolean) => void
}
...
const initialState: State = {
  ...
  maxActiveToasts: 4,
  openTradeOverviewInNewWindow: true
}
...
export const useNotificationStore = create<NotificationState>()(
  persist(
    (set, get) => ({
      ...
      setMaxActiveToasts: (maxActiveToasts: number) => set({ maxActiveToasts }),
      setOpenTradeOverviewInNewWindow: (newWindow: boolean) =>
        set({ openTradeOverviewInNewWindow: newWindow })
    }),
    {
